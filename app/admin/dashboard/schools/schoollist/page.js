    ...
    <div className="container mt-2">
      ...
      <div className="table-responsive bg-white rounded-4 p-3">
                ...
                <tr key={school.school_id}>
                    ...
                    {school.students && school.students.length > 0 ? (
                      <div>
                        {school.students.map((student) => (
                          <div key={student.id} className="small">
                            {student.fullname}
                          </div>
                        ))}
                      </div>
                  ...
                  <td className="position-relative">
                    <button
                      ...
                      onClick={() =>
                        setDropdownIndex(
                          dropdownIndex === paginationData.startIndex + index
                            ? null
        ...
        <div className="d-flex justify-content-between align-items-center px-2 pt-2">
          <span>
            Showing {paginationData.showingStart} to {paginationData.showingEnd}{" "}
                ...
                {getPageNumbers().map((page, index) => (
                  ...
                  >
                    {page === "..." ? (
                      ...
                      <button
                        className={`page-link ${
                          page === currentPage ? "bg-danger border-danger" : ""
                        }`}
